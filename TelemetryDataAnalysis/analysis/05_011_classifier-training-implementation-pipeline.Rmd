...
> *NOTE*: The model fits best when the data has been scaled to its own mean and standard deviation, not that of the original training data.
> Therefore, I should probably not rely on scaling the data, just smoothing it.
> Since the RF is a non-parametric model, this should not effect its performance, but the scaled data will be needed for the HMM.
